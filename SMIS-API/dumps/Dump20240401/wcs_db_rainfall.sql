...
CREATE TABLE `rainfall` (
  `rainfall_id` int NOT NULL,
  `paddy_field_id` int DEFAULT NULL,
  `rainfall_status` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`rainfall_id`),
  KEY `paddy_field_id` (`paddy_field_id`),
  CONSTRAINT `rainfall_ibfk_1` FOREIGN KEY (`paddy_field_id`) REFERENCES `paddyfield` (`paddy_field_id`) ON DELETE RESTRICT ON UPDATE CASCADE
