...
CREATE TABLE `soilmoisture` (
  ...
  `soil_moisture_level` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`soil_moisture_id`),
  KEY `paddy_field_id` (`paddy_field_id`),
  CONSTRAINT `soilmoisture_ibfk_1` FOREIGN KEY (`paddy_field_id`) REFERENCES `paddyfield` (`paddy_field_id`) ON DELETE RESTRICT ON UPDATE CASCADE
